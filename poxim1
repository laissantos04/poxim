...
int main(int argc, char* argv[]) {
	...
	while (fscanf(input, "%x", &valor) != EOF && index < (8 * 1024)) {
		MEM32[index++] = valor;
    }

    /* Para checar se a memória está sendo carregada corretamente
	printf("\nMEM32:\n");
